"""
Django settings for facial_identification project.
...
SECRET_KEY = 'django-insecure-o(!hu7-q1n2xq(qi+p!#o+#^9kyzfy7juty_lztd3lmi&^jd+_'
...
ROOT_URLCONF = 'facial_identification.urls'
...
WSGI_APPLICATION = 'facial_identification.wsgi.application'
